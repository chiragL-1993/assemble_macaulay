...
// Initial process - could incorporate the code and accesstoken request into the redirect URI if we wanted to improve it
//$api = new AcuityAPI(null, null, $sc);
//echo $api->getAuthURL(); // call this url in browser and add email of acuity account and then click access to get code in the url
//exit;
//echo PHP_EOL;
//print_r($api->getAccessToken("BMjIm1ANbU5eFzZbErdLIEi2gHbMMAwt159Dq6s4"));
//exit;
$access_token = "jiccDUHpx3gIazD8ltjVx7EMdJQAwNBEv6g2N5hK"; //TODO - Need to replace this with Assemble Acuity Access Token
...
if ($calendar_id != "12688812" && $calendar_id != "12756907") {
